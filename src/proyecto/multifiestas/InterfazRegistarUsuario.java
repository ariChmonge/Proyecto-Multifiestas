...
public class InterfazRegistarUsuario extends javax.swing.JFrame {
     ...
     */
    public InterfazRegistarUsuario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazRegistarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazRegistarUsuario().setVisible(true);
            }
        });
    }
